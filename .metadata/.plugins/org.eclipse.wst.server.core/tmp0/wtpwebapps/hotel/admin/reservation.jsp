...
<body>
    ...
    <div class="container">
        ...
        <% if (validReservation) { %>
            <div class="success-message">Votre réservation a été confirmée !</div>
           
        <% } %>

        <form action="reservation.jsp" method="post" class="form-container">
            ...
            <div class="form-footer">
                <button type="submit" style="width: 100%;">Réserver maintenant</button>
                <button type="button" style="width: 100%;" onclick="window.history.back();">Retour</button>
            </div>
        </form>
    </div>
