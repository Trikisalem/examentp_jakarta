...
<head>
  ...
  <style>
    ...
    body {
      ...
      background-color: #f0f4f8; /* Arrière-plan gris clair pour un contraste agréable */
      display: flex;
    ...
    h1 {
      color: #007BFF; /* Bleu clair utilisé pour le texte */
      font-size: 24px;
      margin-bottom: 10px;
    }
...
<body>
  ...
  <%-- Logique JSP pour gérer la connexion avec la base de données --%>
  <%
